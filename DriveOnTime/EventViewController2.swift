...
//        self.view.bringSubviewToFront(timeLabelSubtitle)
        ...
        timeLabelSubtitle.font = UIFont(name: "HelveticaNeue-Light", size: 18)
    ...
    func setupCard() {
        ...
        timeLabelSubtitle.topAnchor.constraint(equalTo: timeLabel.bottomAnchor, constant: -5).isActive = true
